...
methodDraw.addExtension("eyedropper", function(S) {
    ...
    return {
      name: "eyedropper",
      svgicons: "/third_party/javascript-khansrc/method-draw-khansrc/method-draw/extensions/eyedropper-icon.xml",
      buttons: [{
        id: "tool_eyedropper",
        type: "mode",
        ...
        position: 8,
        key: "I",
        icon: "/third_party/javascript-khansrc/method-draw-khansrc/method-draw/extensions/eyedropper.png",
        events: {
          "click": function() {
