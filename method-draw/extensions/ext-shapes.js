...
methodDraw.addExtension("shapes", function() {
  ...
  function loadLibrary(cat_id) {
    ...
    if(!lib) {
      ...
      $.getJSON('/third_party/javascript-khansrc/method-draw-khansrc/method-draw/extensions/shapelib/' + cat_id + '.json', function(result, textStatus) {
  ...
  return {
    svgicons: "/third_party/javascript-khansrc/method-draw-khansrc/method-draw/extensions/ext-shapes.xml",
    buttons: [{
      id: "tool_shapelib",
      type: "mode_flyout", // _flyout
      position: 6,
      title: "Shape library",
      icon: "/third_party/javascript-khansrc/method-draw-khansrc/method-draw/extensions/ext-shapes.png",
      events: {
        "click": function() {
